...
parser.add_argument('--input_dir', default='/Github/NeRD-Rain/Datasets/Rain200L/test/input/', type=str, help='Directory of validation images')
parser.add_argument('--output_dir', default='./results/Rain200L', type=str, help='Directory of validation images')
parser.add_argument('--weights', default='/Github/NeRD-Rain/model_large_Rain200L.pth', type=str, help='Path to weights') 
